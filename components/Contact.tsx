					...
					<div className="flex flex-col justify-around mt-7 sm:mt-10 xl:mt-11">
						...
						<motion.div
							...
							onClick={() => {
								if (copyPromptRef.current) {
									console.log(
										"copyPromptRef.current",
										copyPromptRef.current
									)
									copyPromptRef.current.style.opacity = "1"
									setTimeout(() => {
										copyPromptRef.current!.style.transform =
											"translateY(-20px)"
									}, 400)
									copyPromptRef.current!.style.transform =
										"translateY(0px)"
									...
									setTimeout(() => {
										copyPromptRef.current!.style.opacity =
											"0"
									}, 1200)
								}
							}}
						>
							<motion.div
								ref={copyPromptRef}
								// variants={copyPrompt}
								className="absolute w-[100%] bottom-[calc(100%+4px)] left-0 opacity-0 duration-500"
							>
