			...
			>
				<div className="flex flex-row justify-between items-center">
					<img
						...
						className="w-[116px] h-[123px] sm:w-[176px] sm:h-[190px] lg:w-[174px] lg:h-[187px] xl:w-[132px] xl:h-[142px] xl:rounded-[13.9847px] lg:rounded-[18.39px] rounded-[12px] sm:rounded-[18.5px]"
						alt="project image"
					/>
